...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.56.105:27017/wallboarddb',
  ...
  serverURL: 'https://172.18.97.86:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.18.97.86:' + apiport + '/api',
  liveQuery: {
